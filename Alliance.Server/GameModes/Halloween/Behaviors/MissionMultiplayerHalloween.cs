using Alliance.Common.GameModes.Halloween.Behaviors;
...
public class MissionMultiplayerHalloween : MissionMultiplayerGameModeBase
{
    ...
    {
        networkPeer.AddComponent<HalloweenRepresentative>();
    }

    protected override void HandleNewClientAfterSynchronized(NetworkCommunicator networkPeer)
    {
        ChangeCurrentGoldForPeer(networkPeer.GetComponent<MissionPeer>(), 120);
        GameModeBaseClient.OnGoldAmountChangedForRepresentative(networkPeer.GetComponent<HalloweenRepresentative>(), 120);
    }
    ...
    public override void OnAgentRemoved(Agent affectedAgent, Agent affectorAgent, AgentState agentState, KillingBlow blow)
    {
        ...
        {
            HalloweenRepresentative teamDeathmatchMissionRepresentative = affectorAgent.MissionPeer.Representative as HalloweenRepresentative;
        ...
        {
            HalloweenRepresentative teamDeathmatchMissionRepresentative2 = assistingHitter.HitterPeer.Representative as HalloweenRepresentative;
        ...
        {
            if (missionPeer2?.Representative is HalloweenRepresentative teamDeathmatchMissionRepresentative3)
            {
