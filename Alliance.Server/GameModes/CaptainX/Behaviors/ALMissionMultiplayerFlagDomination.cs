...
namespace Alliance.Server.GameModes.CaptainX.Behaviors
{
	...
	public class ALMissionMultiplayerFlagDomination : MissionMultiplayerFlagDomination
	{
		...
		protected ALMissionMultiplayerFlagDominationClient _gameModeFlagDominationClient;
		...
		public override void OnBehaviorInitialize()
		{
			...
			_gameModeFlagDominationClient = Mission.Current.GetMissionBehavior<ALMissionMultiplayerFlagDominationClient>();
			_morale = 0f;
