...
{
    public class ALBehaviorMPGrenadier : BehaviorComponent
    {
        ...
        private const float MaxLateralOffset = 30f;
        public ALBehaviorMPGrenadier(Formation formation)
            : base(formation)
        {
        ...
        protected override void CalculateCurrentOrder()
        {
         ...
         Formation.QuerySystem.ClosestSignificantlyLargeEnemyFormation.MedianPosition.AsVec2
                 .DistanceSquared(Formation.QuerySystem.AveragePosition) >= 700f)
            {
                Vec2 enemyPos = Formation.QuerySystem.ClosestSignificantlyLargeEnemyFormation.MedianPosition.AsVec2;
        ...
        public override void TickOccasionally()
        {
            ...
            FormationBehaviorHelper.GetBestTargetFormation(Formation, FormationClass.HeavyInfantry);
            ...
            if (FormationBehaviorHelper.IsEnemyCavalry(enemyFS.Formation) == true && distance <= 25f)
            {
            ...
            else if (distance > (Formation.QuerySystem.MissileRangeAdjusted * 1.0f))
            {
                ...
                FormationBehaviorHelper.SetUnitSpacing(Formation, unitSpacing);
            }
            else
            {
        ...
        {
            if (Formation.FormationIndex == FormationClass.HeavyInfantry)
            {
                return 1.2f;
            }
            return 0f;
