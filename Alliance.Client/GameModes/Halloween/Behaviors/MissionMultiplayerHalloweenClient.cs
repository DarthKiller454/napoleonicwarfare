...
public class MissionMultiplayerHalloweenClient : MissionMultiplayerGameModeBaseClient
{
    ...
    private HalloweenRepresentative _myRepresentative;
    ...
    {
        _myRepresentative = GameNetwork.MyPeer.GetComponent<HalloweenRepresentative>();
    }
