...
namespace Alliance.Server.Extensions.AIBehavior.Behaviors
{
    ...
    public class ALGlobalAIBehavior : MissionNetwork
    {
        ...
        private void OnRoundStart()
        {
            ...
            EnableAIAfterTimer(
                (Config.Instance.TimeBeforeStart +
                 MultiplayerOptions.OptionType.RoundPreparationTimeLimit
                     .GetIntValue(MultiplayerOptions.MultiplayerOptionsAccessMode.CurrentMapOptions)) * 1000
            );
        }
