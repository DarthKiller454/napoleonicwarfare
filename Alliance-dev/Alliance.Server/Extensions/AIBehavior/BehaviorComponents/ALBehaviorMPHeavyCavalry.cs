...
{
    public class ALBehaviorMPHeavyCavalry : BehaviorComponent
    {
        private bool _hasFlanked = false;

        public ALBehaviorMPHeavyCavalry(Formation formation)
            : base(formation)
        {
        ...
        protected override void CalculateCurrentOrder()
        {
            ...
            else if (target == null || target.MedianPosition.AsVec2.DistanceSquared(Formation.QuerySystem.AveragePosition) <= 1250f)
            {
                _hasFlanked = true;
        ...
        public override void TickOccasionally()
        {
            ...
            FormationBehaviorHelper.GetBestTargetFormation(Formation, FormationClass.HeavyCavalry);
        }
        ...
        {
            if (Formation.FormationIndex == FormationClass.HeavyCavalry)
            {
                return 1.2f;
            }
            return 0f;
