...
namespace Alliance.Server.Extensions.AIBehavior.TeamAIComponents
{
    ...
    /// </summary>
    public class ALTeamAIGeneralSoft : TeamAIGeneral
    {
        ...
        public ALTeamAIGeneralSoft(Mission currentMission, Team currentTeam, float thinkTimerTime = 10f, float applyTimerTime = 1f) : base(currentMission, currentTeam, thinkTimerTime, applyTimerTime)
        {
        }
        ...
        public override void OnUnitAddedToFormationForTheFirstTime(Formation formation)
        {
                ...
                && formation.CountOfUnits > 0)
            {
                ...
                formation.AI.AddAiBehavior(new ALBehaviorMPGrenadier(formation));
                formation.AI.AddAiBehavior(new ALBehaviorMPLightInfantry(formation));
                formation.AI.AddAiBehavior(new ALBehaviorMPLineInfantry(formation));
                formation.AI.AddAiBehavior(new ALBehaviorMPSkirmisher(formation));
                formation.AI.AddAiBehavior(new ALBehaviorMPCavalry(formation));
                formation.AI.AddAiBehavior(new ALBehaviorMPDragoon(formation));
                formation.AI.AddAiBehavior(new ALBehaviorMPHeavyCavalry(formation));
            }
        }
    }
}