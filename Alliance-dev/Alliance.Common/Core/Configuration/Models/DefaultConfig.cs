...
namespace Alliance.Common.Core.Configuration.Models
{
	...
	public class DefaultConfig
	{
		...
		public string BotDifficulty = nameof(Difficulty.Bannerlord);
		...
		public int FreeRespawnTimer = 45;
		...
		[ConfigProperty("Show Custom Usernames", "Show Custom names, (WARNING UNSTABLE)", ConfigValueType.Bool)]
		public bool ShowOfficers = false;
