...
namespace Alliance.Common.GameModels
{
	public class ExtendedAgentApplyDamageModel : AgentApplyDamageModel
	{
		...
		public override float CalculateDamage(in AttackInformation attackInformation, in AttackCollisionData collisionData, in MissionWeapon weapon, float baseDamage)
		{
			...
			if(currentUsageItem != null && currentUsageItem.IsMeleeWeapon && weapon.Item.StringId.Contains("bandage") && attackInformation.VictimAgent != null && attackInformation.VictimAgent.IsActive())
			{
