...
namespace Alliance.Common.Patch
{
	...
	{
		public const int MAX_MISSION_OBJECTS = 10000000;
		...
		public static void IncreaseNativeLimits()
		{
            ...
            CompressionMission.MissileSpeedCompressionInfo = new CompressionInfo.Float(0f, 22, 0.05f);
			CompressionMission.RangedSiegeWeaponAmmoCompressionInfo = new CompressionInfo.Integer(0, 12);


            CompressionMission.SelectedTroopIndexCompressionInfo = new CompressionInfo.Integer(-1, 25, true);
		...
		public static bool Patch()
		{
            ...
            patchSuccess &= Patch_MultiplayerIntermissionVotingManager.Patch();
            ...
            patchSuccess &= Patch_DestructableComponent_OnHit.Patch();
            patchSuccess &= Patch_MissionPeer.Patch();
            patchSuccess &= Patch_UsableMachine_OnInit.Patch();
            ...
            //patchSuccess &= Patch_RangedSiegeWeapon_DetermineDefaultBattleSide.Patch();
#if !SERVER && DEBUG
