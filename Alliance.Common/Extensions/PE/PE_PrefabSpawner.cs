...
namespace Alliance.Common.Extensions.PE
{
    public class PE_PrefabSpawner : UsableMissionObject
    {
        ...
        protected override void OnTick(float dt)
        {
            ...
            if (GameNetwork.IsServer)
            {
                foreach (WeakGameEntity gameEntity in StrayEntity.Keys.ToList())
                {
                    if (gameEntity == null)
                    {
        ...
        protected override void OnInit()
        {
            ...
            SpawnedPrefabs = new List<WeakGameEntity>();
            StrayEntity = new Dictionary<WeakGameEntity, IStray>();
        }
        ...
        public override void OnUse(Agent userAgent, sbyte agentBoneIndex)
        {
            ...
            if (GameNetwork.IsServer)
            {
                ...
                EquipmentIndex wieldedItemIndex = userAgent.GetPrimaryWieldedItemIndex();
        ...
        private void SpawnSpawnableItem(Agent userAgent, SpawnableItem spawnableItem)
        {
            ...
            MissionObject missionObject = Mission.Current.CreateMissionObjectFromPrefab(spawnableItem.PrefabName, frame, null);
        ...
        private void DespawnNearest(Agent userAgent)
        {
            ...
            SpawnedPrefabs.Sort(delegate (WeakGameEntity s, WeakGameEntity s2)
            {
            ...
            WeakGameEntity spawnedEntity = SpawnedPrefabs.FirstOrDefault();
