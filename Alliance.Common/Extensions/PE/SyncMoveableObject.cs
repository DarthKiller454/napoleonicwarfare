...
namespace Alliance.Common.Extensions.PE
{
    public class SyncMoveableArty : MissionNetwork
    {
        ...
        {
            List<WeakGameEntity> gameEntities = base.Mission.GetActiveEntitiesWithScriptComponentOfType<PE_MoveableMachine>().ToList();
            foreach (WeakGameEntity g in gameEntities)
            {
