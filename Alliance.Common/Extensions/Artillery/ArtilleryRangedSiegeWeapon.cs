...
using static TaleWorlds.MountAndBlade.RangedSiegeWeapon;
...
namespace Alliance.Common.Extensions.Artillery
{
    public class ArtilleryRangedSiegeWeapon : BaseFieldSiegeWeapon
    {
        ...
        protected override void OnInit()
        {
            ...
            DefaultSide = BattleSideEnum.None;
            ApplyAimChange();
        }
        ...
        {
            if (this.LoadAmmoStandingPoint != null && this.LoadAmmoStandingPoint.HasUser)
            {
                var user = this.LoadAmmoStandingPoint.UserAgent;
                            ...
                            if (!(action == act_pickup_boulder_begin))
                            {
                                if (action == act_pickup_boulder_end)
                                {
                                    ...
                                    if (user.IsAIControlled)
                                    {
                                        ...
                                        {
                                            user.AIMoveToGameObjectEnable(this.LoadAmmoStandingPoint, this, Agent.AIScriptedFrameFlags.NoAttack);
                                        }
                                        ...
                                        {
                                            user.AIMoveToGameObjectEnable(this.ReloaderAgentOriginalPoint, this, Agent.AIScriptedFrameFlags.NoAttack);
                                        }
                                        else
                                        {
