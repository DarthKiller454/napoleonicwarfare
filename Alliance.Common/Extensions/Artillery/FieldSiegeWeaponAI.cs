...
using Axis = Alliance.Common.Extensions.Artillery.CommonAIFunctions.Axis;
    ...
    public class FieldSiegeWeaponAI : UsableMachineAIBase
    {
        ...
        private Target FindNewTarget()
        {
            var findNewTarget = GetAllThreats()
                ...
                .ToList();
            return findNewTarget.Count > 0
                ? findNewTarget.OrderByDescending(target => target.UtilityValue).First()
                : null;
        }
