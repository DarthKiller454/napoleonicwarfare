    ...
    public abstract class BaseFieldSiegeWeapon : RangedSiegeWeapon
    {
        ...
        public bool IsSafeToFire()
        {
            ...
            using (new TWSharedMutexReadLock(Scene.PhysicsAndRayCastLock))
            {
                ...
                Mission.Current.Scene.RayCastForClosestEntityOrTerrain(MissileStartingGlobalPositionForSimulation, MissileStartingGlobalPositionForSimulation + ShootingDirection.NormalizedCopy() * 25, out distanceE, out WeakGameEntity _, 0.05f);
            }
