...
namespace Alliance.Common.Extensions.Vehicles.Scripts
{
    ...
    public class CS_Carriage : CS_Vehicle
    {
        ...
        protected WeakGameEntity PivotFrontMain;
        protected WeakGameEntity PivotFrontLeft;
        protected WeakGameEntity PivotFrontRight;
        protected WeakGameEntity WheelBackLeft;
        protected WeakGameEntity WheelBackRight;
        protected WeakGameEntity WheelFrontLeft;
        protected WeakGameEntity WheelFrontRight;
        protected List<WeakGameEntity> HorsePositions = new List<WeakGameEntity>();
        protected Dictionary<WeakGameEntity, Agent> HorseAtPosition = new Dictionary<WeakGameEntity, Agent>();
        ...
        public void SpawnHorses()
        {
            ...
            foreach (WeakGameEntity child in HorsePositions)
            {
        ...
        {
            foreach (WeakGameEntity horsePos in HorsePositions)
            {
