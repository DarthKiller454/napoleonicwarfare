...
namespace Alliance.Common.Extensions.Vehicles.Scripts
{
    public class CS_Vehicle : UsableMachine
    {
        ...
        public float _brakeCooldown = 0f;
        ...
        public virtual void ApplyEmergencyBrake()
        {
            _brakeCooldown = 0.5f;           // half a second lockout
            CurrentForwardSpeed = 0f;
            DecelerationRate = 0f;
            ForwardAccelerationRate = 0f;
            ...
            {
                SetGlobalFrameSynched(ref frame, true);
            }
        }
        ...
        {
            return new TextObject("Prefab Spawner");
        }
    }
