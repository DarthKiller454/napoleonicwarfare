...
namespace Alliance.Common.Core.Configuration.Models
{
	...
	public static class AllianceData
	{
		...
		public static string[] AvailableCultures() => Alliance.Common.Utilities.Factions.Instance.OrderedCultureKeys.ToArray();
		...
		public static readonly string[] AvailableGameModes = new string[] { "Lobby", "PvC", "CvC", "CaptainX", "BattleX", "SiegeX", "TeamDeathmatchX", "DeathmatchX", "Groupfight", "Halloween"};
