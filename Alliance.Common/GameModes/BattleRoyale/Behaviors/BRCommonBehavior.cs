...
namespace Alliance.Common.GameModes.BattleRoyale.Behaviors
{
    public class BRCommonBehavior : MissionMultiplayerGameModeBaseClient, IBotControllerBehavior
    {
