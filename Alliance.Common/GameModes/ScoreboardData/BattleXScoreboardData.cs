...
namespace Alliance.Common.GameModes.ScoreboardData
{
    ...
    public class BattleXScoreboardData : IScoreboardData
    {
        ...
        public MissionScoreboardComponent.ScoreboardHeader[] GetScoreboardHeaders()
        {
            ...
            array[0] = new MissionScoreboardComponent.ScoreboardHeader("ping", (MissionPeer missionPeer) => TaleWorlds.Library.MathF.Round(missionPeer.GetNetworkPeer().AveragePingInMilliseconds).ToString(), (BotData bot) => "");
