...
namespace Alliance.Client.Extensions.ExNativeUI.LobbyEquipment.ViewModels
{
	public class ALHeroInformationVM : ViewModel
	{
		...
		public ALHeroInformationVM()
		{
			...
			IsArmyAvailable = MultiplayerOptions.OptionType.NumberOfBotsPerFormation.GetIntValue() > 0 && Mission.Current.GetMissionBehavior<MissionMultiplayerGameModeBaseClient>() is not ScenarioClientBehavior;
		...
		public void RefreshWith(MultiplayerClassDivisions.MPHeroClass heroClass, List<IReadOnlyPerkObject> perks)
		{
			...
			ArmySize = MathF.Max(MathF.Ceiling(num2), 1);
