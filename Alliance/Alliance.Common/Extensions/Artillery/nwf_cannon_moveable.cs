                ...
                foreach (StandingPointWithWeaponRequirement standingPointWithWeaponRequirement in this.AmmoPickUpStandingPoints)
                {
                    if (standingPointWithWeaponRequirement.HasUser)
                    {
                        ...
                        if (!(currentAction == NWF_Cannon_Moveable.act_pickup_boulder_begin))
                        {
                            ...
                            else if (!userAgent.SetActionChannel(1, NWF_Cannon_Moveable.act_pickup_boulder_begin, false, 0UL, 0f, 1f, -0.2f, 0.4f, 0f, false, -0.2f, 0, true) && userAgent.Controller != Agent.ControllerType.AI)
                            {
                                userAgent.StopUsingGameObject(true);
                            }
                        }
